...
public class Partido {
	...
	public Partido(Integer id_partido, LocalDate fecha, LocalTime hora, String rival, String lugar,
			enumResultado resultado, Integer goles_a_favor, Integer goles_en_contra) {
